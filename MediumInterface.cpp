...
SDL_Window* mediumInterfaceWindow = nullptr;
...
void loadMediumFishAssets(){
    ...
    const char* fishPaths[12] = {
        ...
        "png/red.png", "png/silver.png", "png/teal.png", "png/piranha.png"
    };
...
void initMediumInterface(){
    ...
    if (mediumInterfaceWindow != nullptr) return;

    game_music = Mix_LoadMUS("music/game_music.mp3");

    mediumInterfaceWindow = SDL_CreateWindow("Medium Mode", 
        SDL_WINDOWPOS_CENTERED, 
        SDL_WINDOWPOS_CENTERED, 
        1280, 720, 
        SDL_WINDOW_BORDERLESS);
    interfaceRenderer = SDL_CreateRenderer(mediumInterfaceWindow ,-1, 
        SDL_RENDERER_ACCELERATED);

    if (!mediumInterfaceWindow) {
...
void handleMediumInterfaceEvents(SDL_Event& e, bool& interfaceOpen) {
    if (!mediumInterfaceWindow) return;
...
void handleMediumInterfaceLogics(SDL_Event& e, bool& mediumInterfaceWindow){
    if (!mediumInterfaceWindow) return;
...
void destroyMediumInterface() {
    ...
    if (mediumInterfaceWindow) SDL_DestroyWindow(mediumInterfaceWindow);
    interfaceRenderer = nullptr;
    mediumInterfaceWindow = nullptr;
...
bool isMediumInterfaceOpen() {
    return mediumInterfaceWindow != nullptr;
}